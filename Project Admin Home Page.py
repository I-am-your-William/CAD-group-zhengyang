...
class Application(tk.Tk):
    def __init__(self, *args, **kwargs):
        ...
        for F in (HomePage, UploadPage, ManagePage, ClinicRequestPage, ViewAllClinicPage, ViewTipsPage ) :
...
class HomePage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        view_all_tips_btn = Button (self.left_side_panel , text = " View All Tips ", font=(20),background="white", command=lambda: controller.show_frame(ViewTipsPage))
...
class UploadPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        self.content_entry.place(height=90,width=600, x=50, y=120)
        ...
        self.link_entry.place(height=30,width=500, x=150, y=250)
...
class ClinicRequestPage(tk.Frame):
    ...
    def accept_request(self, clinic_id):
        ...
        more_info_frame = tk.Frame(self.request_frame, background="white")
...
class ViewTipsPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.top_frame1 = Frame(self.tipsView_frame , background="light grey")
        self.top_frame1.place(height=60, width=1000, x=1, y=1)
